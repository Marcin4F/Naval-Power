...
public class Pancernik : Ship
{
    ...
    private void Awake()
    {
        transform.position = new Vector3(PlayerPrefs.GetFloat("PancernikX"), PlayerPrefs.GetFloat("PancernikY"), PlayerPrefs.GetFloat("PancernikZ"));
    ...
    private void OnApplicationQuit()
    {
        ...
        PlayerPrefs.DeleteKey("PancernikY");
    ...
    private void Update()
    {
        ...
        PlayerPrefs.SetFloat("PancernikY", transform.position.y);
